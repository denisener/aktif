                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    @can('add_product_category')
                                        <div class="mt-1">
                                            <a href="#" id="add_category" class="text-blue fs-13 fw-600 hov-opacity-80 has-transition">{{translate('Add Catgeory') }}</a>
                                        </div>
                                    @endcan
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    @can('add_measurement_points')
                                        <div class="mt-1">
                                            <a href="#" id="add_measurement_point" class="text-blue fs-13 fw-600 hov-opacity-80 has-transition">{{translate('Add Measurement Point') }}</a>
                                        </div>
                                    @endcan
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    @can('add_product_attribute')
                                        <div class="mt-1">
                                            <a href="#" id="add_attribute" class="text-blue fs-13 fw-600 hov-opacity-80 has-transition">{{translate('Add Size Option') }}</a>
                                        </div>
                                    @endcan
                                </div>
                            </div>
