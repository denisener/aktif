        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('custom_label.update', $custom_label->id) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="lang" value="{{ $lang }}">

                        <div class="form-group">
                            <label class="col-from-label fs-13">{{ translate('Text') }}</label>
                            <input type="text" class="form-control" name="text"
                                value="{{ $custom_label->getTranslation('text', $lang) }}" required
                                @if(($custom_label->id == 200 || $custom_label->id == 201 || $custom_label->id == 202 || $custom_label->id == 203) && $lang == 'en') readonly @endif>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control aiz-color-input" name="background_color"
                                    value="{{ $custom_label->background_color }}" required>
                            ...
                            <div class="d-flex align-items-center">
                                <label class="aiz-megabox d-block bg-white mb-0 mr-4" style="flex: 1; min-width: 120px;">
                                    <input type="radio" name="text_color" value="white"
                                        @checked($custom_label->text_color == 'white')>
                                ...
                                <label class="aiz-megabox d-block bg-white mb-0" style="flex: 1; min-width: 120px;">
                                    <input type="radio" name="text_color" value="dark"
                                        @checked($custom_label->text_color == 'dark')>
                                    <span class="d-flex align-items-center aiz-megabox-elem rounded-0"
                                        style="padding: 0.75rem 1.2rem;">
                                        <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (existingIds.length > 0) {
                $.post(
                    '{{ route('custom_labels.product_edit') }}',
                    {
                        _token: '{{ csrf_token() }}',
        ...
        function customLabelFilterProducts() {
            ...
            customLabelSearchTimer = setTimeout(function () {
                ...
                $.post(
                    '{{ route('custom_labels.product_search') }}',
