                    ...
                    <div class="dropdown float-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                            <div class="table-options">
                                ...
                                @can('gmc_product_edit')
                                <a href="javascript:void(0)"
                                    class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue" onclick="singlePush({{$product->id}})">
                                    <span>
                                    ...
                                    <span class="fs-14 text-secondary fw-500 pl-10px">{{translate('Push to GMC')}}</span>
                                </a>
                                @endcan
                               
                                @can('gmc_product_delete')
                                <!--Delete-->
                                <a href="javascript:void(0)"
                                    class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue text-nowrap" onclick="removeFromGmc({{$product->id}})">
                                    <span>
                                    ...
                                    <span class="fs-14 text-danger fw-500 pl-5px">{{translate('Remove from GMC')}}</span>
                                </a>
                                @endcan
